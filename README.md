...
Every business runs on the same questions: what's selling, who's buying, where are we losing money? The answers are already in the data — someone just has to dig them out.

That's my job. I clean the data, explore it, find the pattern, and build a dashboard that shows it clearly — usually starting in SQL or Python and ending in Power BI or Excel.

I also know the data engineering side — SQL Server, ETL, star schemas — so I can take a project from raw files to final report without waiting on anyone.
